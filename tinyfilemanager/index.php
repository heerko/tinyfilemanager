...
//Application Title
define('APP_TITLE', 'HDSC File drop');
...
/*
checks if a file called 'index.css' is in the current directory
and if so, return a link tag to it
*/
function add_local_stylesheet()
{
	// get current path
	$path = FM_ROOT_PATH;
	if (FM_PATH != '') {
...
?>
	...
	<head>
		...
		<meta name="robots" content="noindex, nofollow">
		<meta name="googlebot" content="noindex">
		<?php add_local_stylesheet(); ?>
		<?php if ($favicon_path) {
			echo '<link rel="icon" href="' . fm_enc($favicon_path) . '" type="image/png">';
		} ?><title><?php echo fm_enc(APP_TITLE) ?></title><?php print_external('pre-jsdelivr'); ?><?php print_external('pre-cloudflare'); ?><?php print_external('css-bootstrap'); ?><?php print_external('css-font-awesome'); ?><?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])) : ?><?php print_external('css-highlightjs'); ?><?php endif; ?><script type="text/javascript">
